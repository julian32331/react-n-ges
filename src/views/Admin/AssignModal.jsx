    ...
    render() {
        ...
        return (
            <Dialog
                ...
                >
                    <h3 className={classes.modalTitle}>Assign to employee</h3>
                </DialogTitle>
                <DialogContent
...
export default withStyles(checkInModalStyle)(withRouter(connect(mapStateToProps, mapDispatchToProps)(AssignModal)));
