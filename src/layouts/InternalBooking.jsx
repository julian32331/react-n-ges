...
class InternalBooking extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            step                : 1,
...
export default withStyles(bookingStyle)(withRouter(connect(mapStateToProps, mapDispatchToProps)(InternalBooking)));
