                                    ...
                                    <div className={classes.infoContainer}>
                                        ...
                                        <GridContainer justify="center">
                                            ...
                                            <GridItem xs={12} sm={5} className={classes.left}>
                                                <h3 style={{marginTop: '0'}}>{this.state.disabledSalonInfo? this.state.disabledSalonInfo.address + " " + this.state.disabledSalonInfo.post : ""}</h3>
                                            </GridItem>
                                        </GridContainer>
                                        <GridContainer justify="center">
                                            <GridItem xs={12} sm={3} className={classes.key}>
                                            ...
                                            <GridItem xs={12} sm={5} className={classes.left}>
                                                <h3 style={{marginTop: '0'}}>{this.state.disabledSalonInfo? this.state.disabledSalonInfo.city : ""}</h3>
                                            </GridItem>
                                        </GridContainer>
                                        <GridContainer justify="center">
                                            <GridItem xs={12} sm={3} className={classes.key}>
