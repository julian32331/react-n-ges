...
class Booking extends React.Component {
    ...
    render() {
        ...
        console.log('disabledSalonInfo: ', this.state.disabledSalonInfo)
        return (
                                    ...
                                    <div className={classes.infoContainer}>
                                        ...
                                        <GridContainer justify="center">
                                            ...
                                            <GridItem xs={12} sm={5} className={classes.left}>
                                                <h3 style={{marginTop: '0'}}>{this.state.disabledSalonInfo? this.state.disabledSalonInfo.address : ""}</h3>
                                            </GridItem>
                                        </GridContainer>
                                        <GridContainer justify="center">
                                            <GridItem xs={12} sm={3} className={classes.key}>
                                                <h3 style={{marginTop: '0'}}><b>Stad: </b></h3>
                                            </GridItem>
                                            <GridItem xs={12} sm={5} className={classes.left}>
                                                <h3 style={{marginTop: '0'}}>{this.state.disabledSalonInfo? this.state.disabledSalonInfo.post + " " + this.state.disabledSalonInfo.city : ""}</h3>
                                            </GridItem>
                                        </GridContainer>
                                        <GridContainer justify="center">
                                            <GridItem xs={12} sm={3} className={classes.key}>
